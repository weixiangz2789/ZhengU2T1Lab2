public class ChatBot {
    ...
    //method prints out the difference between debbie's birth month and user's birth month
    public void birthMonth(int debbieMonth, int yourMonth){
        int difference = debbieMonth - yourMonth;
        if (difference < 0){
            difference = difference * -1;
        }
        System.out.println("Our birth months are " + difference + " apart!");
    }

    //method multiplies the value of the three numbers and returns them
